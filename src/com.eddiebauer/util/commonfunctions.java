...
import static com.eddiebauer.base.BaseFactory.*;
...
public class commonfunctions {
    ...
    public static void generateAndSendEmail() throws MessagingException, IOException {
        ...
        String emailServer = util.LoadConfigFile.getValue("smtpserver");
        String emailTo = util.LoadConfigFile.getValue("SendTo");
        String emailCC = util.LoadConfigFile.getValue("SentCC");
        String emailFrom = util.LoadConfigFile.getValue("SendFrom");
        String emailPort = util.LoadConfigFile.getValue("port");
        String sendEmail1 = util.LoadConfigFile.getValue("SentCC1");
        String env = util.LoadConfigFile.getValue("Environment");
